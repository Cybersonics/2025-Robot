...
public class ReleaseClimberSpool extends Command {
  ...
  public ReleaseClimberSpool(Climber climber) {
  ...
  @Override
  public void execute() {
    this._climber.positionClimber(this._encoderExpectedPosition, false);
  }
